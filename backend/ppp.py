...
# ---------------- FAST PAGE RENDERING ----------------
def render_page_fast(page, scale: float = 5) -> Image.Image:
    """
    ...
    try:
        ...
        for page_idx in tqdm(range(len(doc)), desc="Extracting All Signals"):
            ...
            if scanned:
                ...
                img = render_page_fast(page, scale=3)
...
if __name__ == "__main__":
    ...
    pdf_files = glob.glob(os.path.join(content_folder, "23_24_nationwide_insurance_company_commerical_general_liability_endt_asimo_food_service_inc__dba_farmer_boys_indio.pdf"))
